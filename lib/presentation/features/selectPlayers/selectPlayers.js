...
document.querySelectorAll('.image-team-indicator').forEach(span => {
    span.addEventListener('click', () => hideThisContainerAndDisplayNewContainer(selectPlayersContainer, captureContainer));
});
